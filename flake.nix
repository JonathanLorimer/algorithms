{
  ...
  in
    utils.eachDefaultSystem (system: let
      ...
      algorithms = craneLib.buildPackage (craneCommon
        // {
    ...
    in {
      checks = {
        ...
        algorithms-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        algorithms-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        algorithms-audit = craneLib.cargoAudit {
